...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"   
      ...
      <xsl:if test="@sec-type">
         <xsl:if test="ancestor::abstract">
            <xsl:call-template name="make-error">
               ...
               <xsl:with-param name="tg-target" select="'tags/#el-abs'"/>
            </xsl:call-template>
         </xsl:if>
      </xsl:if>
   </xsl:template>
   ...
   <xsl:template name="ms-article-meta-content-test">
      <xsl:if
         ...
         <xsl:call-template name="make-error">
            ...
            <xsl:with-param name="tg-target" select="'tags/#el-artmeta'"/>
         </xsl:call-template>
      </xsl:if>
      <xsl:if
         test="
   ...
   <xsl:template name="ms-back-content-test">
      <xsl:if test="title">
         <xsl:call-template name="make-error">
            ...
            <xsl:with-param name="tg-target" select="'tags/#el-back'"/>
         </xsl:call-template>
      </xsl:if>
   </xsl:template>
         ...
         <xsl:if test="$dtd-version = '2'">
            <xsl:if test="not(sec[@sec-type = 'display-objects'])">
               <xsl:call-template name="make-error">
                  ...
                  <xsl:with-param name="tg-target" select="'dobs/#figtab'"/>
               </xsl:call-template>
            </xsl:if>
         </xsl:if>
   ...
   <xsl:template name="ms-contrib-attribute-test">
      ...
      <xsl:if test="not(@contrib-type)">
         <xsl:call-template name="make-error">
            ...
            <xsl:with-param name="tg-target" select="'tags/#el-contrib'"/>
         </xsl:call-template>
      </xsl:if>
   ...
   <xsl:template name="ms-contrib-group-aff-test">
      ...
      <xsl:if test="aff and contrib/aff">
         <xsl:call-template name="make-error">
            ...
            <xsl:with-param name="tg-target" select="'dobs/#dob-auaff'"/>
         </xsl:call-template>
      </xsl:if>
   </xsl:template>
   ...
   <xsl:template name="ms-contrib-group-content-test">
      ...
      <xsl:if
         ...
         <xsl:call-template name="make-error">
            ...
            <xsl:with-param name="tg-target" select="'tags/#el-cgroup'"/>
         </xsl:call-template>
      </xsl:if>
   ...
   <xsl:template name="ms-disp-formula-content-test">
      <xsl:if test="inline-graphic | tex-math | array | chem-struct">
         <xsl:call-template name="make-error">
            ...
            <xsl:with-param name="tg-target" select="'tags/#el-dispform'"/>
         </xsl:call-template>
      </xsl:if>
   </xsl:template>
   ...
   <xsl:template name="ms-front-content-test">
      ...
      <xsl:if
         ...
         <xsl:call-template name="make-error">
            ...
            <xsl:with-param name="tg-target" select="'tags/#el-front'"/>
         </xsl:call-template>
      </xsl:if>
   ...
   <xsl:template name="ms-subj-group-test">
      ...
      <xsl:if
         ...
         <xsl:call-template name="make-error">
            ...
            <xsl:with-param name="tg-target" select="'genprac/#formatting'"
            />
         </xsl:call-template>
      </xsl:if>
   </xsl:template>
   ...
   <xsl:template name="aff-alternatives-content-check">
      ...
      <xsl:if
         ...
         <xsl:call-template name="make-error">
            ...
            <xsl:with-param name="tg-target"
               select="'tags/#el-aff-alternatives'"/>
         </xsl:call-template>
      </xsl:if>
   ...
   <xsl:template name="alternatives-unique-att-values">
      ...
      <xsl:variable name="my-su-value" select="$nodes[1]/@specific-use"/>
      <xsl:if test="$nodes">
         <xsl:choose>
            <xsl:when test="$my-att-value = $nodes[position() != 1]/@*[name(.) = $att-name]">
               <xsl:choose>
                  <xsl:when test="$my-su-value != $nodes[position() != 1][@*[name(.) = $att-name]]/@specific-use">
   ...
   <!-- Template: alternatives-xml-lang-check
		1) Exactly 1 $nodes must have same @xml:lang as /article,
                   but nodes that duplicate the article's xml:lang are
                   allowed if they are distinguished by @specific-use
   ...
   <xsl:template name="alternatives-xml-lang-check">
      ...
      <xsl:if test="count($nodes[@xml:lang = $art-lang-att] | $nodes[not(@xml:lang)]) != 1">
         <xsl:choose>
            <xsl:when test="$nodes[1][@xml:lang]/@specific-use = $nodes[position() != 1][@*[name(.) = $att-name]]/@specific-use">
               <xsl:call-template name="unique-xml-lang-count-error">
                  <xsl:with-param name="context" select="$context"/>
                  <xsl:with-param name="nodes" select="$nodes"/>
               </xsl:call-template>
            </xsl:when>
            <xsl:when test="not($nodes/@specific-use)">
               <xsl:call-template name="unique-xml-lang-count-error">
                  <xsl:with-param name="context" select="$context"/>
                  <xsl:with-param name="nodes" select="$nodes"/>
               </xsl:call-template>
   ...
   <xsl:template name="unique-xml-lang-count-error">
      <xsl:param name="context"/>
      <xsl:param name="nodes"/>
      <xsl:call-template name="make-error">
         <xsl:with-param name="error-type">
         ...
         <xsl:with-param name="description">
            ...
            <xsl:text>] in [</xsl:text>
            <xsl:value-of select="$context"/>
            <xsl:text>] must have the same @xml:lang as [article].</xsl:text>
         </xsl:with-param>
      </xsl:call-template>
   </xsl:template>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <xsl:call-template name="make-error">
               ...
               <xsl:with-param name="tg-target" select="'tags/#el-artid'"/>
            </xsl:call-template>
         </xsl:otherwise>
      </xsl:choose>
   </xsl:template>
      ...
      <xsl:for-each select="//processing-instruction('release-delay')">
         ...
         <!--			<xsl:if test="not(contains(.,'|')) ">
            <xsl:call-template name="make-error">
               ...
               <xsl:with-param name="tg-target" select="'genprac/#embargo'"/>
            </xsl:call-template>
         </xsl:if>
                        ...
                        <xsl:choose>
                           ...
                           <xsl:otherwise>
                              <xsl:call-template name="make-error">
                                 ...
                                 <xsl:with-param name="tg-target" select="'dobs/#dob-arttype'"/>
                              </xsl:call-template>
                           </xsl:otherwise>
                        </xsl:choose>
                     </xsl:when>
   ...
   <!-- Template: block-formatting-check 
        ...
        <bold> or <sc> or <monospace> or <strike> or
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <xsl:call-template name="make-error">
               ...
               <xsl:with-param name="class">
                  <xsl:choose>
                     <xsl:when test="$stream = 'manuscript' and ancestor::caption">error</xsl:when>
   ...
   <xsl:template name="book-abstract-length-test">
      <xsl:if test="string-length(normalize-space(.)) &gt; 9900">
         ...
         <xsl:call-template name="make-error">
            ...
            <!-- <xsl:with-param name="tg-target" select="'dobs/#dob-abs'"/> -->
         </xsl:call-template>
      </xsl:if>
   </xsl:template>
  ...
  -->
      ...
      <xsl:if test="count($context/element-citation) > 1">
         ...
         <xsl:if
            ...
            <xsl:call-template name="make-error">
               ...
               <xsl:with-param name="tg-target"
                  select="'tags/#el-citation-alternatives'"/>
            </xsl:call-template>
         </xsl:if>
         <!-- element-citation: 3 -->
   ...
   <xsl:template name="citation-type-value">
      ...
      <xsl:call-template name="attribute-present-not-empty">
         ...
         <xsl:with-param name="tg-target" select="'tags/#el-cit'"/>
      </xsl:call-template>
   </xsl:template>
   ...
   <xsl:template name="collab-alternatives-content-check">
      ...
      <xsl:if
         ...
         <xsl:call-template name="make-error">
            ...
            <xsl:with-param name="tg-target"
               select="'tags/#el-collab-alternatives'"/>
         </xsl:call-template>
      </xsl:if>
      ...
      <xsl:choose>
         ...
         <xsl:when test="not(@rid[normalize-space()])">
            <xsl:call-template name="make-error">
               ...
               <xsl:with-param name="tg-target" select="'tags/#el-cnum'"/>
            </xsl:call-template>
         </xsl:when>
      ...
      <xsl:choose>
         ...
         <xsl:when
            ...
            <xsl:call-template name="make-error">
               ...
               <xsl:with-param name="tg-target" select="'tags/#cspons'"/>
            </xsl:call-template>
         </xsl:when>
   ...
   <xsl:template name="contrib-id-check">
      ...
      <xsl:if test="not($context/@contrib-id-type)">
         <xsl:call-template name="make-error">
            ...
            <xsl:with-param name="tg-target" select="'tags/#el-contrib-id'"/>
         </xsl:call-template>
      </xsl:if>
   ...
   <xsl:template name="copyright-statement-check">
      ...
      <xsl:if
         ...
         <xsl:call-template name="make-error">
            ...
            <xsl:with-param name="class" select="'warning'"/>
            <xsl:with-param name="tg-target" select="'tags/#el-cstatement'"
            />
         </xsl:call-template>
      </xsl:if>
   </xsl:template>
         ...
         <xsl:otherwise>
            <xsl:if test="contains($context, 'Creative Commons')
               ...
               <xsl:call-template name="make-error">
                  ...
                  <xsl:with-param name="class" select="'error'"/>
                  <xsl:with-param name="tg-target" select="'dobs/#dob-license'"/>
               </xsl:call-template>
            </xsl:if>
         </xsl:otherwise>
      </xsl:choose>
   ...
   <xsl:template name="copyright-year-check">
      ...
      <xsl:if test="$is-valid-year = 'false'">
         <xsl:call-template name="make-error">
            ...
            <xsl:with-param name="tg-target" select="'tags/#el-cyear'"/>
         </xsl:call-template>
      </xsl:if>
   </xsl:template>
         ...
         <xsl:otherwise>
            ...
            <xsl:if test="$is-valid-day = 'false'">
               <xsl:call-template name="make-error">
                  ...
                  <xsl:with-param name="tg-target" select="'tags/#el-day'"/>
               </xsl:call-template>
            </xsl:if>
         </xsl:otherwise>
      </xsl:choose>
            ...
            <xsl:otherwise>
               <xsl:call-template name="make-error">
                  ...
                  <xsl:with-param name="tg-target">
                     <xsl:choose>
                        <xsl:when test="$stream = 'manuscript'">
                           <xsl:text>dobs/#dob-msdisc</xsl:text>
                        </xsl:when>
                        <xsl:when
                           test="$document-type != 'book' and $document-type != 'book-part'">
                           <xsl:text>dobs/#dob-pmcdisc</xsl:text>
                        </xsl:when>
                     </xsl:choose>
                  </xsl:with-param>
               </xsl:call-template>
   ...
   <xsl:template name="doi-format-test">
      ...
      <xsl:variable name="doi-uncovered-space">
         <xsl:variable name="spaces" select="concat(
          '&#x0020;&#x00a0;&#x1361;&#x1680;',
          '&#x2002;&#x2003;&#x2004;&#x2005;&#x2006;&#x2007;',
          '&#x2008;&#x2009;&#x200a;&#x200b;&#x202F;&#x205F;',
          '&#x2420;&#x3000;&#x303f;&#xfeff;')"/>
         <xsl:value-of select="normalize-space(translate($doi,$spaces,
          '                         '))"/>
      </xsl:variable>

      <xsl:variable name="normalized-doi">
         <xsl:call-template name="replace-substring">
            <xsl:with-param name="main-string" select="normalize-space($doi-uncovered-space)"/>
   ...
   <!-- *********************************************************** -->
   <!-- Template: dup-id-type-check

        There must be only one journal-id and pub-id with a
        given @journal-id-type or @pub-id-type.
        Note: article-id is handled in dup-pub-id-type-check.
     -->
   <!-- *********************************************************** -->
   <xsl:template name="dup-id-type-check">
      <xsl:param name="att-name"/>
      <xsl:param name="context" select="."/>
      <xsl:variable name="context-name" select="local-name($context)"/>
      <xsl:variable name="att-value" select="$context/@*[name(.) = $att-name]"/>
      <xsl:choose>
         <xsl:when test="local-name($context) = 'journal-id' and @journal-id-type = 'publisher-id'"/> <!-- duplicates of this are fine -->
         <xsl:when test="$context/preceding-sibling::*[name(.) = $context-name]/@*[name(.) = $att-name] = $att-value">
            <xsl:call-template name="make-error">
               <xsl:with-param name="error-type">duplicate id-type check</xsl:with-param>
               <xsl:with-param name="description">
                  <xsl:text>There should be only one &lt;</xsl:text>
                  <xsl:value-of select="name(self::node())"/>
                  <xsl:text>&gt; with the type '</xsl:text>
            ...
            <xsl:choose>
               ...
               <xsl:otherwise>
                  <xsl:variable name="txt">
                     <xsl:call-template name="really-normalize-space">
                        <xsl:with-param name="str" select="string($context)"/>
                     </xsl:call-template>
                  </xsl:variable>
                  <xsl:if test="$txt = '' ">
                     <xsl:call-template name="make-error">
   ...
   <xsl:template name="really-normalize-space">
      <xsl:param name="str"/>
      ...
      <xsl:value-of select="normalize-space(translate($str,$spaces,
         '                         '))"/>
   </xsl:template>
   ...
   <xsl:template name="epub-date-check">
      ...
      <xsl:if
         ...
         <xsl:call-template name="make-error">
            ...
            <xsl:with-param name="tg-target" select="'tags/#el-pubdate'"/>
         </xsl:call-template>
      </xsl:if>
   ...
   <xsl:template name="fn-attribute-check">
      ...
      <xsl:if test="$context/@symbol">
         <xsl:call-template name="make-error">
            ...
            <xsl:with-param name="tg-target" select="'tags/#el-fn'"/>
         </xsl:call-template>
      </xsl:if>
   </xsl:template>
                  ...
                  <xsl:call-template name="make-error">
                     ...
                     <xsl:with-param name="description">
                        ...
                        <xsl:text>"&gt; element.  If these are alternate forms of the same formula, they must all be wrapped in &lt;alternatives&gt;.
								If more than one formula is represented here, each should be in its own &lt;</xsl:text>
                        <xsl:value-of select="name()"/>
                        <xsl:text>&gt;.</xsl:text>
                        <xsl:call-template name="get-context"/>
                     </xsl:with-param>
                     <!-- <xsl:with-param name="tg-target" select="'tags/#el-fpage'"/> -->
                  </xsl:call-template>
   ...
   <xsl:template name="supplemental-issue-check">
      <xsl:call-template name="make-error">
         ...
         <xsl:with-param name="tg-target" select="'tags/#el-issue'"/>
      </xsl:call-template>
   </xsl:template>
   <!-- *********************************************************** -->
   ...
   <xsl:template name="id-present-test">
      <xsl:if test="not(@id)">
         <xsl:call-template name="make-error">
            ...
            <xsl:with-param name="tg-target" select="'dobs/#dob-ids'"/>
         </xsl:call-template>
      </xsl:if>
   </xsl:template>
   ...
   <xsl:template name="issn-pub-type-check">
      <xsl:if
         ...
         <xsl:call-template name="make-error">
            ...
            <xsl:with-param name="tg-target" select="'tags/#el-issn'"/>
         </xsl:call-template>
      </xsl:if>
   </xsl:template>
         ...
         <xsl:otherwise>
            ...
            <xsl:if
               ...
               <xsl:call-template name="make-error">
                  ...
                  <xsl:with-param name="tg-target" select="'tags/#el-jmeta'"
                  />
               </xsl:call-template>
            </xsl:if>
         </xsl:otherwise>
   ...
   <!-- *********************************************************** -->
   <!-- Template: lang-attribute-check
       1) the jats 1.4 lang-* attributes are not allowed
     -->
   <!-- *********************************************************** -->

   <xsl:template name="lang-attribute-check">
      <xsl:if test="//@lang-focus
                  | //@lang-focus-custom
                  | //@lang-group
                  | //@lang-grouping
                  | //@lang-source
                  ...
                  | //@lang-variant-custom">
         <xsl:call-template name="make-error">
            <xsl:with-param name="error-type">lang attribute check</xsl:with-param>
            <xsl:with-param name="description">
               <xsl:text>PMC is not ready to receive the language attribute present in this XML file. Please contact your PMC journal manager.</xsl:text>
            </xsl:with-param>
         </xsl:call-template>
      </xsl:if>
   </xsl:template>
		...
		<xsl:if test="contains($href-ns, 'creative') and contains($href-ns, 'commons') and not(contains($href-ns, 'us.sagepub.com'))">
			...
			<xsl:if test="not(contains($ok-urls, concat(' ', $href-standardized, ' ')))">
				<xsl:call-template name="make-error">
					...
					<xsl:with-param name="tg-target" select="'tags/#el-license'"/>
				</xsl:call-template>
			</xsl:if>
			...
			<xsl:if test="contains($href, '/licences/')">
				<xsl:call-template name="make-error">
					...
					<xsl:with-param name="tg-target">tags/#el-license</xsl:with-param>
					<xsl:with-param name="class">warning</xsl:with-param>
				</xsl:call-template>
			</xsl:if>
		</xsl:if>
			...
			<xsl:otherwise>
				...
				<xsl:if test="string($normalized-href) != string($normalized-linktext)">
					<xsl:call-template name="make-error">
						...
						<xsl:with-param name="tg-target" select="'tags/#el-extlink'"/>
					</xsl:call-template>
				</xsl:if>
			</xsl:otherwise>
		</xsl:choose>
   ...
   <xsl:template name="license-integrity-check">
      ...
      <xsl:if
         test="(contains(normalize-space($context), 'Creative Commons') or contains(normalize-space($context), 'CC BY')) and not(contains($context//@xlink:href, 'creativecommons')) and not($context/ali:license_ref[contains(., 'creativecommons')])">
         <xsl:call-template name="make-error">
   ...
   <xsl:template name="list-item-content-check">
      ...
      <xsl:if test="$context[@list-type != 'simple']/label">
         <xsl:call-template name="make-error">
            ...
            <xsl:with-param name="tg-target" select="'tags/#el-litem'"/>
         </xsl:call-template>
      </xsl:if>
      ...
      <xsl:choose>
         ...
         <xsl:when test="$is-ok-list-type != '1'">
            <xsl:call-template name="make-error">
               ...
               <xsl:with-param name="tg-target" select="'tags/#el-list'"/>
            </xsl:call-template>
         </xsl:when>
      </xsl:choose>
   </xsl:template>
            ...
            <xsl:if
               ...
               <xsl:call-template name="make-error">
                  ...
                  <xsl:with-param name="tglink"
                     select="'https://pmc.ncbi.nlm.nih.gov/tagging-guidelines/manuscript/tags/#el-math'"
                  />
               </xsl:call-template>
            </xsl:if>
         </xsl:when>
         <xsl:when test="$style = 'article'">
            <xsl:if
               ...
               <xsl:call-template name="make-error">
                  ...
                  <xsl:with-param name="class" select="'warning'"/>
                  <xsl:with-param name="tglink"
                     select="'https://pmc.ncbi.nlm.nih.gov/tagging-guidelines/article/tags/#el-math'"
                  />
               </xsl:call-template>
            </xsl:if>
         </xsl:when>
...
<!-- only mml:mtext and mml:mn are sent to this test -->
   ...
   <!-- *********************************************************** -->
   <!-- Template: mml-empty-base-or-scripts-check

        All children of msub, msup, msubsup, munder, mover, and
        munderover must have text.
   -->
   <!-- *********************************************************** -->
   <xsl:template name="mml-empty-base-or-script-check">
      <xsl:param name="name"/>
      ...
      <xsl:variable name="second-child-text">
         <xsl:call-template name="really-normalize-space">
            <xsl:with-param name="str" select="*[2]"/>
         </xsl:call-template>
      </xsl:variable>    
      <xsl:if test="$first-child-text = ''">
         <xsl:call-template name="make-error">
            <xsl:with-param name="error-type" select="'mathml empty base or script check'"/>
            <xsl:with-param name="class" select="'warning'"/>
            <xsl:with-param name="description">
               <xsl:text>mathml element </xsl:text>
               <xsl:value-of select="$name"/>
               <xsl:text> must not have an empty base expression.</xsl:text>
            </xsl:with-param>
         </xsl:call-template>
      </xsl:if>   
      <xsl:if test="$second-child-text = ''">
         <xsl:call-template name="make-error">
            <xsl:with-param name="error-type" select="'mathml empty base or script check'"/>
            <xsl:with-param name="class" select="'warning'"/>
            <xsl:with-param name="description">
               <xsl:text>mathml element </xsl:text>
               <xsl:value-of select="$name"/>
               <xsl:text> must not have an empty </xsl:text>
               <xsl:choose>
                  <xsl:when test="$name = 'msub'">subscript.</xsl:when>
                  <xsl:when test="$name = 'msup'">superscript.</xsl:when>
                  <xsl:when test="$name = 'msubsup'">subscript.</xsl:when>
                  <xsl:when test="$name = 'munder'">underscript.</xsl:when>
                  <xsl:when test="$name = 'mover'">overscript.</xsl:when>
                  <xsl:when test="$name = 'munderover'">underscript.</xsl:when>
                  <xsl:otherwise>second expression.</xsl:otherwise>
               </xsl:choose>
            </xsl:with-param>
         </xsl:call-template>
      </xsl:if>     
      <xsl:if test="$name = 'msubsup' or $name = 'munderover'">
         <xsl:variable name="third-child-text">
            <xsl:call-template name="really-normalize-space">
               <xsl:with-param name="str" select="*[3]"/>
            </xsl:call-template>
         </xsl:variable>      
         <xsl:if test="$third-child-text = '' ">
            <xsl:call-template name="make-error">
               <xsl:with-param name="error-type" select="'mathml empty base or script check'"/>
               <xsl:with-param name="class" select="'warning'"/>
               <xsl:with-param name="description">
                  ...
                  <xsl:text> must not have an empty </xsl:text>
                  <xsl:choose>
                     <xsl:when test="$name = 'msubsup'">superscript.</xsl:when>
                     <xsl:when test="$name = 'munderover'">overscript.</xsl:when>
                     <xsl:otherwise>third expression.</xsl:otherwise>
                  </xsl:choose>
               </xsl:with-param>
            </xsl:call-template>   
         </xsl:if>
         ...
         <xsl:when
            ...
            <xsl:if test="$stream = 'manuscript' and number($context) > 12">
               <xsl:call-template name="make-error">
                  ...
                  <xsl:with-param name="tg-target" select="'tags/#el-month'"
                  />
               </xsl:call-template>
            </xsl:if>
         </xsl:when>
      ...
      <xsl:if test="count($context/name[not(@content-type = 'index')]) > 1">
         <xsl:if
            ...
            <xsl:call-template name="make-error">
               ...
               <xsl:with-param name="tg-target"
                  select="'tags/#el-name-alternatives'"/>
            </xsl:call-template>
         </xsl:if>
      ...
      <xsl:if
         ...
         <xsl:call-template name="make-error">
            ...
            <xsl:with-param name="description">
               ...
               <xsl:value-of select="local-name($context)"/>
               <xsl:text> only contains given-names, it must specify @name-style="given-only".</xsl:text>
            </xsl:with-param>
         </xsl:call-template>
      </xsl:if>
   ...
   <xsl:template name="notes-in-proof-check">
      ...
      <xsl:if test="$context[@notes-type = 'note-in-proof'][not(parent::back)]">
         <xsl:call-template name="make-error">
            ...
            <xsl:with-param name="tg-target" select="'dobs/#dob-notesip'"/>
         </xsl:call-template>
      </xsl:if>
   </xsl:template>
   ...
   <xsl:template name="oa-license-present">
      <xsl:if test="not(/article/front/article-meta/permissions/license)">
         <xsl:call-template name="make-error">
            ...
            <xsl:with-param name="tg-target" select="'tags/#el-openaccess'"
            />
         </xsl:call-template>
      </xsl:if>
   </xsl:template>
   ...
   <xsl:template name="related-article-check">
      ...
      <xsl:choose>
         ...
         <xsl:when test="not($context/@related-article-type)">
            <xsl:call-template name="make-error">
               ...
               <xsl:with-param name="tg-target" select="'tags/#el-relart'"/>
            </xsl:call-template>
         </xsl:when>
      ...
      <xsl:variable name="subarticle-ok-list"
         select="
            concat(
      ...
      <xsl:variable name="rat-ok">
         <xsl:call-template name="is-in-list">
            <xsl:with-param name="list">
               <xsl:choose>
                  <xsl:when test="($context/ancestor::sub-article | $context/ancestor::response)">
                     <xsl:value-of select="concat(translate($ok-list, ',', ''), translate($subarticle-ok-list, ',', ''))"/>
                  </xsl:when>
                  <xsl:otherwise>
                     <xsl:value-of select="translate($ok-list, ',', '')"/>
                  </xsl:otherwise>
               </xsl:choose>
            </xsl:with-param>
   ...
   <xsl:template name="related-object-check">
      ...
      <xsl:if test="not(@id)">
         <xsl:call-template name="make-error">
            ...
            <xsl:with-param name="tg-target" select="'tags/#el-relobj'"/>
         </xsl:call-template>
      </xsl:if>
            ...
            <xsl:if test="@xlink:href = $doi">
               <xsl:choose>
                  <xsl:when
                     ...
                     @related-article-type = 'editor-report'"/>
      ...
      <xsl:if test="string-conf">
         <xsl:call-template name="make-error">
            ...
            <!-- Not specified in TG; string-conf is only in Green and TG are strictly for Blue
 				<xsl:with-param name="tg-target" select="'style/'"/>  -->
         </xsl:call-template>
      </xsl:if>
   </xsl:template>
...
<xsl:with-param name="error-type">string-date check</xsl:with-param>
   ...
   <xsl:template name="subj-group-check">
      ...
      <xsl:if
         ...
         <xsl:call-template name="make-error">
            ...
            <xsl:with-param name="tg-target" select="'tags/#el-artcat'"/>
         </xsl:call-template>
      </xsl:if>
      ...
      <xsl:if test="$context[@subj-group-type = 'heading'] and compound-subject">
         <xsl:call-template name="make-error">
            ...
            <xsl:with-param name="tg-target" select="'dobs/#dob-subjects'"/>
         </xsl:call-template>
      </xsl:if>
   ...
   <xsl:template name="title-fn-check-OBS">
      ...
      <xsl:if test="$context/fn">
         <xsl:call-template name="make-error">
            ...
            <xsl:with-param name="tg-target" select="'dobs/#dob-atitle'"/>
         </xsl:call-template>
      </xsl:if>
   </xsl:template>
   ...
   <!-- Template: web-ext-link-check  
        ...
        1) @xlink:href must start with http://, https://, ftp://, ftps://,
           www., ftp., or sftp.
     -->
   <!-- *********************************************************** -->
   <xsl:template name="web-ext-link-check">
      <xsl:param name="context" select="."/>
      <xsl:variable name="lc-href">
         <xsl:call-template name="knockdown">
            <xsl:with-param name="str" select="$context/@xlink:href"/>
         </xsl:call-template>
      </xsl:variable>
      <xsl:choose>

         <!-- @xlink:href must start with one of these -->
         <xsl:when
            test="starts-with(normalize-space($lc-href), 'http://')
                  or starts-with(normalize-space($lc-href), 'https://')
                  or starts-with(normalize-space($lc-href), 'ftp://')
                  or starts-with(normalize-space($lc-href), 'ftps://')
                  or starts-with(normalize-space($lc-href), 'www.')
                  or starts-with(normalize-space($lc-href), 'ftp.')
                  or starts-with(normalize-space($lc-href), 'sftp.')">
            <!-- No problem -->
         </xsl:when>

         <!-- No @xlink:href: this is caught in ext-link-attribute-check -->
         ...
         <xsl:otherwise>
            <xsl:call-template name="make-error">
               <xsl:with-param name="error-type">web links
                  check</xsl:with-param>
               <xsl:with-param name="description">
                  <xsl:text>@xlink:href should begin with 'http://', 'https://', 'ftp://', 'ftps://, 'www.',</xsl:text>
                  <xsl:text> 'ftp.', or 'sftp.'</xsl:text>
                  <xsl:text> Provided: '</xsl:text><xsl:value-of select="$context/@xlink:href"/><xsl:text>'.</xsl:text>
               </xsl:with-param>
            </xsl:call-template>
         </xsl:otherwise>
      </xsl:choose>
      ...
      <xsl:choose>
         ...
         <xsl:when test="$context[@ref-type and not(@rid)] and $stream != 'rrn'">
            <xsl:call-template name="make-error">
               ...
               <xsl:with-param name="tg-target" select="'tags/#el-xref'"/>
            </xsl:call-template>
         </xsl:when>
		...
		<xsl:if test="@ref-type = 'aff'">
			...
			<xsl:if test=" 
				...
				<xsl:call-template name="make-error">
					...
					<xsl:with-param name="tg-target" select="'tags/#el-aff'"/>
				</xsl:call-template>
			</xsl:if>			
		</xsl:if>
	</xsl:template>
               ...
               <xsl:call-template name="make-error">
                  ...
                  <xsl:with-param name="description"
                     select="
                        ...
                        '].')"/>
                  <xsl:with-param name="tg-target" select="'tags/#el-year'"
                  />
               </xsl:call-template>
            </xsl:if>
         </xsl:otherwise>
